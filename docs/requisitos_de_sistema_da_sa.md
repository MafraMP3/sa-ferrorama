...
RN 3 \- O administrador deve ter uma tela própria para ele, tendo opções para sair do sistema, ver os sensores cadastrados contendo ID do sensor, localização, tipo de dado, exclusão e visualizar mais detalhes.  
...
RF 4 \- O sistema deve impedir a exclusão de sensores que tem dados registrados.  
...
RNF 1 \- O sistema deve responder a tela de login em até 3 segundos.  
RNF 2 \- O sistema deve ter ao menos um simples sistema de segurança.   
RNF 3 \- O sistema deve ser rápido e responder comandos de forma dinâmica.  
RNF 4 \- O sistema deve ser responsivo a qualquer tela e dispositivo.
